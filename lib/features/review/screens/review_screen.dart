...
class _ReviewScreenState extends ConsumerState<ReviewScreen> {
  ...
  String get _completionText {
    if (widget.checkOutDate != null) {
      ...
      return 'Hoàn thành ngày ${fmt.format(widget.checkOutDate!)}';
    }
            ...
            child: Column(
              ...
              children: [
                ...
                RatingCriteriaRow(
                  label: 'Vệ sinh',
                  rating: _cleanliness,
                  onRatingChanged: (v) => setState(() => _cleanliness = v),
                ),
                RatingCriteriaRow(
                  label: 'Vị trí',
                  rating: _location,
                  onRatingChanged: (v) => setState(() => _location = v),
                ),
                RatingCriteriaRow(
                  label: 'Dịch vụ',
                  rating: _service,
                  onRatingChanged: (v) => setState(() => _service = v),
                ),
                RatingCriteriaRow(
                  label: 'Giá trị',
                  rating: _value,
                  onRatingChanged: (v) => setState(() => _value = v),
                ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Chia sẻ trải nghiệm của bạn để giúp những du khách khác...',
    ...
    if (success && mounted) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            'Đánh giá của bạn đã được ghi lại và sẽ giúp ích rất nhiều cho cộng đồng du khách.',
          ),
          actions: [
            TextButton(
              onPressed: () {
