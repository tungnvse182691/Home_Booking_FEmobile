        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                const Text('Chọn ngày lưu trú', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                Text(widget.roomName, style: const TextStyle(color: Colors.grey, fontSize: 14)),
              ],
            ),
          ),
          ...
          TableCalendar(
            ...
            calendarStyle: CalendarStyle(
              ...
              todayDecoration: BoxDecoration(color: AppTheme.primary.withOpacity(0.4), shape: BoxShape.circle),
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(child: _buildInfoColumn('Check-in', dateFormat.format(_rangeStart!))),
                      Expanded(child: _buildInfoColumn('Check-out', dateFormat.format(_rangeEnd!))),
                      Expanded(child: _buildInfoColumn('Số đêm', '${_rangeEnd!.difference(_rangeStart!).inDays} đêm')),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        currencyFormat.format(_rangeEnd!.difference(_rangeStart!).inDays * widget.pricePerNight),
